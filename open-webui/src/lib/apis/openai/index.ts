...
export const getOpenAIConfig = async (token: string = '') => {
	...
	const res = await fetch(`${WEBUI_OBJ.OPENAI2_API_BASE_URL}/config`, {
		method: 'GET',
		headers: {
...
export const updateOpenAIConfig = async (token: string = '', enable_openai_api: boolean) => {
	...
	const res = await fetch(`${WEBUI_OBJ.OPENAI2_API_BASE_URL}/config/update`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getOpenAIUrls = async (token: string = '') => {
	...
	const res = await fetch(`${WEBUI_OBJ.OPENAI2_API_BASE_URL}/urls`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const updateOpenAIUrls = async (token: string = '', urls: string[]) => {
	...
	const res = await fetch(`${WEBUI_OBJ.OPENAI2_API_BASE_URL}/urls/update`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getOpenAIKeys = async (token: string = '') => {
	...
	const res = await fetch(`${WEBUI_OBJ.OPENAI2_API_BASE_URL}/keys`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const updateOpenAIKeys = async (token: string = '', keys: string[]) => {
	...
	const res = await fetch(`${WEBUI_OBJ.OPENAI2_API_BASE_URL}/keys/update`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getOpenAIModels = async (token: string, urlIdx?: number) => {
	...
	const res = await fetch(
		`${WEBUI_OBJ.OPENAI2_API_BASE_URL}/models${typeof urlIdx === 'number' ? `/${urlIdx}` : ''}`,
		{
			method: 'GET',
			headers: {
				Accept: 'application/json',
...
export const generateOpenAIChatCompletion = async (
	token: string = '',
	body: object,
	url: string = WEBUI_OBJ.OPENAI2_API_BASE_URL
...
export const synthesizeOpenAISpeech = async (
	...
	const res = await fetch(`${WEBUI_OBJ.OPENAI2_API_BASE_URL}/audio/speech`, {
		method: 'POST',
		headers: {
			Authorization: `Bearer ${token}`,
			'Content-Type': 'application/json'
