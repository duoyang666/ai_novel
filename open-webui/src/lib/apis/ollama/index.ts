...
export const getOllamaConfig = async (token: string = '') => {
	...
	const res = await fetch(`${WEBUI_OBJ.OLLAMA2_API_BASE_URL}/config`, {
		method: 'GET',
		headers: {
...
export const updateOllamaConfig = async (token: string = '', enable_ollama_api: boolean) => {
	...
	const res = await fetch(`${WEBUI_OBJ.OLLAMA2_API_BASE_URL}/config/update`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getOllamaUrls = async (token: string = '') => {
	...
	const res = await fetch(`${WEBUI_OBJ.OLLAMA2_API_BASE_URL}/urls`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const updateOllamaUrls = async (token: string = '', urls: string[]) => {
	...
	const res = await fetch(`${WEBUI_OBJ.OLLAMA2_API_BASE_URL}/urls/update`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getOllamaVersion = async (token: string, urlIdx?: number) => {
	...
	const res = await fetch(`${WEBUI_OBJ.OLLAMA2_API_BASE_URL}/api/version${urlIdx ? `/${urlIdx}` : ''}`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getOllamaModels = async (token: string = '') => {
	...
	const res = await fetch(`${WEBUI_OBJ.OLLAMA2_API_BASE_URL}/api/tags`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const generateTitle = async (
	...
	const res = await fetch(`${WEBUI_OBJ.OLLAMA2_API_BASE_URL}/api/generate`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const generateEmbeddings = async (token: string = '', model: string, text: string) => {
	...
	const res = await fetch(`${WEBUI_OBJ.OLLAMA2_API_BASE_URL}/api/embeddings`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const generateChatCompletion = async (token: string = '', body: object) => {
	...
	const res = await fetch(`${WEBUI_OBJ.OLLAMA2_API_BASE_URL}/api/chat`, {
...
export const createModel = async (
	...
	const res = await fetch(
		`${WEBUI_OBJ.OLLAMA2_API_BASE_URL}/api/create${urlIdx !== null ? `/${urlIdx}` : ''}`,
		{
			method: 'POST',
			headers: {
				Accept: 'application/json',
...
export const deleteModel = async (token: string, tagName: string, urlIdx: string | null = null) => {
	...
	const res = await fetch(
		`${WEBUI_OBJ.OLLAMA2_API_BASE_URL}/api/delete${urlIdx !== null ? `/${urlIdx}` : ''}`,
		{
			method: 'DELETE',
			headers: {
				Accept: 'application/json',
...
export const pullModel = async (token: string, tagName: string, urlIdx: string | null = null) => {
	...
	const res = await fetch(`${WEBUI_OBJ.OLLAMA2_API_BASE_URL}/api/pull${urlIdx !== null ? `/${urlIdx}` : ''}`, {
		signal: controller.signal,
		method: 'POST',
		headers: {
			Accept: 'application/json',
...
export const downloadModel = async (
	...
	const res = await fetch(
		`${WEBUI_OBJ.OLLAMA2_API_BASE_URL}/models/download${urlIdx !== null ? `/${urlIdx}` : ''}`,
		{
			method: 'POST',
			headers: {
				Accept: 'application/json',
...
export const uploadModel = async (token: string, file: File, urlIdx: string | null = null) => {
	...
	const res = await fetch(
		`${WEBUI_OBJ.OLLAMA2_API_BASE_URL}/models/upload${urlIdx !== null ? `/${urlIdx}` : ''}`,
		{
			method: 'POST',
			headers: {
				Authorization: `Bearer ${token}`
...
// 	return await fetch(`${WEBUI_OBJ.OLLAMA2_API_BASE_URL}/pull`, {
// 		method: 'POST',
// 		headers: {
